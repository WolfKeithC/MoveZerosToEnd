 ...
 *         &lt;element name="callArgs" type="{http://schemas.microsoft.com/2003/10/Serialization/Arrays}ArrayOfanyType" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class Post {
    ...
    @XmlElementRef(name = "callArgs", namespace = "urn:xytechsystems.com/XytechAPI", type = JAXBElement.class, required = false)
    protected JAXBElement<ArrayOfanyType> callArgs;
    ...
    /**
     * Gets the value of the callArgs property.
     * 
     * @return
     *     possible object is
     ...
     *     
     */
    public JAXBElement<ArrayOfanyType> getCallArgs() {
        return callArgs;
    }

    /**
     * Sets the value of the callArgs property.
     * 
     * @param value
     *     allowed object is
     *     {@link JAXBElement }{@code <}{@link ArrayOfanyType }{@code >}
     *     
     */
    public void setCallArgs(JAXBElement<ArrayOfanyType> value) {
        this.callArgs = value;
    }
